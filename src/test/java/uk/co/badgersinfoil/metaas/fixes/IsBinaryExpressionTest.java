...
/**
 * This tests checks if the IS binary operation is parsed correctly
 *
 * @author Alexander Eliseyev
 */
public class IsBinaryExpressionTest extends TestCase {
	public void testIt() {
        ...
        assertEquals(ASBinaryExpression.Op.IS, binaryExpression.getOperator());
	...
	private ASCompilationUnit loadSyntaxExample(ActionScriptFactory fact) {
		InputStream in = getClass().getClassLoader().getResourceAsStream("IsBinaryExpression.as");
