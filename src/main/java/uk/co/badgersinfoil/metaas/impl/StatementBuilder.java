...
public class StatementBuilder {
	...
	public static Statement build(LinkedListTree ast) {
		switch (ast.getType()) {
			...
			case AS3Parser.CONDITIONAL_COMPILATION_BLOCK:
				return new ASTASConditionalCompilationBlock(ast);
			case AS3Parser.DO:
            ...
            case AS3Parser.USE:
                return new ASTASUseNamespaceStatement(ast);
            case AS3Parser.FUNC_DEF:
                return new ASTASLocalFunction(ast);
            case AS3Parser.IMPORT:
                return new ASTASImportStatement(ast);
            case AS3Parser.NAMESPACE_DEF:
                return new ASTASNamespaceStatement(ast);
            default:
