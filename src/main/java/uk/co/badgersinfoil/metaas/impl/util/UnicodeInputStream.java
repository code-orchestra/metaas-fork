...
public class UnicodeInputStream extends InputStream {
    ...
    public UnicodeInputStream(InputStream in) {
        ...
        try {
            ...
            throw new RuntimeException("Can't init input stream", e);
        }
    }
    ...
    /**
     * Read-ahead BOM_SIZE bytes and check for BOM marks. Extra
     bytes are
    ...
    protected void init() throws IOException {
        ...
        if (  (bom[0] == (byte)0xEF) && (bom[1] == (byte)0xBB)
                ...
                (bom[2] == (byte)0xBF) ) {
            encoding = "UTF-8";
            // Duplicate BOM case - RE-2731
            if ((bom[3] == (byte)0xEF) && (bom[4] == (byte)0xBB) && (bom[5] == (byte)0xBF)) {
                unread = n - 6;
            } else {
                unread = n - 3;
            }
